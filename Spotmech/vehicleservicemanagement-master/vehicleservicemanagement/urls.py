...
urlpatterns = [
    ...
    path('delete-mechanic/<int:pk>', views.delete_mechanic_view,name='delete-mechanic'),
    path('admin-view-mechanic-rating',views.admin_view_mechanic_rating_view,name='admin-view-mechanic-rating'),
    path('update-rating/<int:pk>', views.update_rating_view,name='update-rating'),
    ...
    path('mechanic-rating', views.mechanic_rating_view,name='mechanic-rating'),
    ...
    path('user-mechanic', views.user_mechanic_view,name='user-mechanic'),
